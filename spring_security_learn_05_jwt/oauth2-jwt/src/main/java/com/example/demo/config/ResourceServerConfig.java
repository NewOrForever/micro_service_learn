...
//    private TokenStore tokenStore;
    ...
    public void configure(ResourceServerSecurityConfigurer resources) throws Exception {
        ...
        /**
         * 这里需要注意下：
         * 因为我这里 RedisTokenStore 和 JwtTokenStore 有 2 个 TokenStore bean，所以需要指定下 -> 不然校验 token 会报错
         * 授权服务和资源服务都需要指定同一个 TokenStore
         *
         * @see ResourceServerConfiguration#tokenStore  使用 @Autowired 自动注入
         * 所以我觉得直接在需要的 TokenStore bean 上加 @Primary 注解就行了
         */

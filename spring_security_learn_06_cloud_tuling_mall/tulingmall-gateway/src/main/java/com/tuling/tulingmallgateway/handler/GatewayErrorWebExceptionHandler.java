package com.tuling.tulingmallgateway.handler;
...
public class GatewayErrorWebExceptionHandler implements ErrorWebExceptionHandler {
        ...
        return response
                .writeWith(Mono.fromSupplier(() -> {
                    ...
                    try {
                        ...
                        R res = R.fail(ex.getMessage());
                        if (ex instanceof GateWayException) {
                            res.setCode(((GateWayException) ex).getCode());
                        }
                        // 返回json异常原因给前端
    ...
    public static class R<T> implements Serializable
    {
        ...
        /** 成功 */
        public static final long SUCCESS = ResultCode.SUCCESS.getCode();

        /** 失败 */
        public static final long FAIL = ResultCode.FAILED.getCode();

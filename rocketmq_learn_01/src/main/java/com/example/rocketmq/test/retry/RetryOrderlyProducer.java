 ...
 * 生产顺序消息
 */
public class RetryOrderlyProducer {
    public static void main(String[] args) throws UnsupportedEncodingException {
        // 实例化生产者
        DefaultMQProducer producer = new DefaultMQProducer("ProducerRetryOrderGroup");
        // 设置NameServer的地址
        ...
        try {
            ...
            for (int i = 0; i < 10; i++) {
                ...
                int orderId = i % 2;
                // 创建消息
                Message msg = new Message("RetryOrderlyTopicTest", tags[i % tags.length], "KEY" + i,

...
public class TracePushConsumer {
    ...
    public static final String CONSUMER_GROUP = "TraceConsumerGroup";
    ...
    public static void main(String[] args) throws InterruptedException, MQClientException {
         ...
         * DefaultMQPushConsumer consumer = new DefaultMQPushConsumer(CONSUMER_GROUP, true, "CustomizedTraceTopic");
         */
        ...
        consumer.setConsumeTimestamp("20240706145500");
